...
class option:
    def __init__(self):
        ...
        self.nEpochs = 150
        self.lr = 0.005 #Learning Rate. Default=0.01s
...
def train(epoch):
    ...
    imgout = input.data
    torchvision.utils.save_image(imgout,"/home/cf716/unet_torch/checkpoint/epch_"+str(epoch)+'.jpg')
...
def checkpoint(epoch):
    model_out_path = "/home/cf716/unet_torch/checkpoint/model_epoch_{}.pth".format(epoch)
